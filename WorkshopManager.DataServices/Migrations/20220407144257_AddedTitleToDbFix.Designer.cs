...
namespace WorkshopManager.DataServices.Migrations
{
    ...
    [Migration("20220407144257_AddedTitleToDbFix")]
    partial class AddedTitleToDbFix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkshopManager.Models.System.BaseModels.Title", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WorkshopManager.Models.CustomerRelationshipManagement.BaseModels.Customer", b =>
                {
                    ...
                    b.HasOne("WorkshopManager.Models.System.BaseModels.Title", "Title")
                        .WithOne("Customer")
                        .HasForeignKey("WorkshopManager.Models.CustomerRelationshipManagement.BaseModels.Customer", "TitleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
